...
/*Cette class vas fonctionner on background dans le but de faire des verification si l'utilisateur a dépasser le temps permis u nn */
public class BackgroundService extends JobIntentService {
    ...
    protected void onHandleWork(@NonNull Intent intent) {
        ...
        HashMap<String, Integer> appUsageMap = UtilsT.getTimeSpent(this, null, beginTime, endTime);
